...
to update  ;; patch procedure
  ...
  let Ediff 2 * spin * sum [ spin ] of neighbors4 + external-field * spin * 2
...
to change-color
  set-current-plot "Magnetization-Field"
  set plotcolor (plotcolor + 20) mod 140
  set-plot-pen-color plotcolor
end
@#$#@#$#@
GRAPHICS-WINDOW
315
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plotxy external-field magnetization"
...
"" ""
PENS
"default" 1.0 0 -16777216 true "" "plotxy temperature magnetization"
